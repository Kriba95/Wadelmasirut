...
export default function LRadioGroupsTwoKotisivut({
  valinta,
  setValinta,
  mainadlinks,
}) {
              ...
              <div className="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                <div className="absolute top-0 p-5 inline-block bg-indigo-600 rounded-xl shadow-lg transform -translate-y-1/2">
                  <link.icon
                    className={`duration-150  h-8 w-8  ${
                      valinta[index] === true ? " text-black" : "text-white"
                    }`}
                ...
                <h3
                  className={`duration-150 text-xl font-medium text-gray-900 ${
                    valinta[index] === true ? " text-white" : "text-gray-900"
                  }`}
                ...
                <p
                  className={`duration-150  mt-4 text-base text-gray-500 ${
                    valinta[index] === true ? " text-white" : "text-gray-500"
                  }`}
              ...
              >
                <p
                  className={`block text-base font-medium duration-150 ${
                    valinta[index] === true ? "text-white" : "text-indigo-700"
                  }`}
                >
                  Valitse
                </p>
