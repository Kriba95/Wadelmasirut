...
const plans = [
  ...
  {
    name: "Nettisivut ja Verkkokauppa",
  },
];
...
export default function LaskuriLomakeRadioOne({ formData, setFormData }) {
  const [selected, setSelected] = useState(plans[0]);

  const handleInputChange = (selectedPlan) => {
    setFormData({
      ...formData,
      radioOne: selectedPlan,
    });
  };
  ...
  return (
    ...
    >
      <RadioGroup.Label className="sr-only">Valitse palvelu</RadioGroup.Label>
